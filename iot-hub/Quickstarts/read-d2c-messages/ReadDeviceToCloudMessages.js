...
var serviceConnectionString = config.iotHubServiceConnectionString;
...
var ehClient;
EventHubClient.createFromIotHubConnectionString(serviceConnectionString)
  .then(function(client) {
    console.log(
      'Successfully created the EventHub Client from iothub connection string.'
    );
    ehClient = client;
